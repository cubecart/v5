...
<p><a href="http://www.alliedwallet.com/"><img src="modules/<?php echo $moduleType; ?>/<?php echo $moduleName; ?>/admin/logo.gif" alt="" border="0" title="" /></a></p>
<?php 
if(isset($msg))
{ 
	echo msg($msg); 
...
<table border="0" cellspacing="1" cellpadding="3" class="mainTable">
  ...
  <tr>
  <td align="left" class="tdText"><strong>Merchant Id:</strong><br/>Get it at <a href="http://www.alliedwallet.com" target="_blank" class="txtLink">http://www.alliedwallet.com</a> (opens in new window)</td>
    <td class="tdText"><input type="text" name="module[MerchantID]" value="<?php echo $module['MerchantID']; ?>" class="textbox" size="30" /></td>
  </tr>
  <tr>
  	<td align="left" class="tdText"><strong>Site ID:</strong></td>
    <td class="tdText"><input type="text" name="module[siteID]" value="<?php echo $module['siteID']; ?>" class="textbox" size="30" /></td>
  </tr>
  <tr>
  <tr>
