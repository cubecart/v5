<div id="addressbook">
  <form action="{$VAL_SELF}" method="post" enctype="multipart/form-data">
	...
	<div>
	  <input type="submit" value="{$LANG.common.delete_selected}" class="button_default right" />
	  <span><a href="{$STORE_URL}/index.php?_a=addressbook&amp;action=add" class="button_default">{$LANG.address.address_add}</a></span>
	</div>
  {/if}
  ...
  {if isset($CTRL_FORM)}
	...
	<div>
	  ...
	  <input type="submit" name="save" value="{$LANG.common.save}" class="button_default" /> <input type="reset" value="{$LANG.common.reset}" class="button_default" />
	</div>
  {/if}
    </form>
</div>
