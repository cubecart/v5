...
<form action="{$VAL_SELF}" method="post" id="newsletter_form_box">
   ...
   <div class="row collapse">
      <div class="small-9 columns"><input name="subscribe" id="newsletter_email" type="text" class="textbox required" size="18" maxlength="250" title="{$LANG.newsletter.subscribe}"/></div>
