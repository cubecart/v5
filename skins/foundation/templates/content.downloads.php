...
<div class="list">
  ...
  <div>
	<span class="actions">
	  <a href="{$STORE_URL}/index.php?_a=download&amp;accesskey={$download.accesskey}" title="{$LANG.common.download}"><img src="{$STORE_URL}/skins/{$SKIN_FOLDER}/images/file_download.png" alt="{$LANG.common.download}" /></a>
	</span>
