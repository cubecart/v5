<form method="post" action="?_a=category" enctype="multipart/form-data">
  ...
  <p></p>
  <fieldset>
	<div><label for="keywords">{$LANG.search.keywords}</label><span><input type="text" class="textbox required" name="search[keywords]" id="keywords" class="" /> *</span></div>
	<div>
  ...
  <p><input type="submit" class="button_default" value="{$LANG.form.submit}" /> <input type="reset" class="button_default" value="{$LANG.common.reset}" /></p>
  </form>