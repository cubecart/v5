...
<div id="Stock" class="tab_content">
  ...
  <fieldset><legend>{$LANG.settings.title_stock_general}</legend>
    ...
    <div><label for="stock_warn_limit">{$LANG.settings.stock_warning_limit}</label><span><input name="config[stock_warn_limit]" id="stock_warn_limit" type="text" class="textbox number" value="{$CONFIG.stock_warn_limit}" /></span></div>
