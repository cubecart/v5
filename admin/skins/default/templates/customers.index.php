<div>
  ...
  <div style="display: none;">
	<div id="address-form" class="tb-form">
	  ...
	  <div><label for="billing">{$LANG.address.billing_address}</label><span><input type="hidden" name="address[billing][]" id="billing"  class="toggle add" /></span></div>
	  <div><label for="default">{$LANG.common.default}</label><span><input type="hidden" name="address[default][]" id="default" class="toggle add" /></span></div>
